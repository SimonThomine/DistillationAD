...
def de_resnet18(progress: bool = True, **kwargs: Any) -> ResNet:

    return _resnet('resnet18', BasicBlock, [2, 2, 2, 2], progress,
                   **kwargs)


def de_resnet34(progress: bool = True, **kwargs: Any) -> ResNet:

    return _resnet('resnet34', BasicBlock, [3, 4, 6, 3], progress,
                   **kwargs)


def de_resnet50(progress: bool = True, **kwargs: Any) -> ResNet:

    return _resnet('resnet50', Bottleneck, [3, 4, 6, 3], progress,
                   **kwargs)


def de_resnet101(progress: bool = True, **kwargs: Any) -> ResNet:

    return _resnet('resnet101', Bottleneck, [3, 4, 23, 3], progress,
                   **kwargs)


def de_resnet152( progress: bool = True, **kwargs: Any) -> ResNet:

    return _resnet('resnet152', Bottleneck, [3, 8, 36, 3], progress,
                   **kwargs)


def de_resnext50_32x4d( progress: bool = True, **kwargs: Any) -> ResNet:
...
def de_resnext101_32x8d( progress: bool = True, **kwargs: Any) -> ResNet:
...
def de_wide_resnet50_2( progress: bool = True, **kwargs: Any) -> ResNet:
...
def de_wide_resnet101_2( progress: bool = True, **kwargs: Any) -> ResNet:
