...
class BN_layer(nn.Module):
    def __init__(self,
                 block: Type[Union[AttnBasicBlock, AttnBottleneck]], # was BasicBlock, Bottleneck
                 layers: int,
                 groups: int = 1,
    ...
    def _make_layer(self, block: Type[Union[AttnBasicBlock, AttnBottleneck]], planes: int, blocks: int,
